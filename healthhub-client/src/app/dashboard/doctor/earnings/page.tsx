...
export default function DoctorEarningsPage() {
    ...
    const handleExportReport = async () => {
        try {
            ...
            workbook.creator = 'Doctor Portal';
            workbook.created = new Date();

            const sheet = workbook.addWorksheet('Earnings Report', {
            ...
            titleCell.value = 'Doctor Earnings Report';
            ...
            const summaryData: [string, string][] = [
                ...
                ['Today', formatCurrency(earnings.today)],
                ['This Week', formatCurrency(earnings.weekly)],
                ['This Month', formatCurrency(earnings.monthly)],
                ['Total Appointments', earnings.appointments.length.toString()],
                ['Completed Appointments', earnings.completedAppointments.length.toString()],
                ['Pending Appointments', earnings.pendingAppointments.length.toString()],
            ];
            ...
            // ---- Appointments Table ----
            const tableHeaderRow = sheet.addRow(['Patient Name', 'Date', 'Time', 'Fee']);
            tableHeaderRow.eachCell((cell) => {
                cell.font = { bold: true, color: { argb: 'FFFFFFFF' } };
                cell.fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FF10B981' } }; // green-500
            ...
            earnings.completedAppointments.forEach((apt: any, idx: number) => {
            ...
            link.href = url;
            link.setAttribute('download', `earnings-report-${new Date().toISOString().split('T')[0]}.xlsx`);
